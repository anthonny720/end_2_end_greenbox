...
class Records(models.Model):
    ...
    #     try:
    #         return (self.get_total_net_weight() * self.get_discount_percentage()) / 100
    #     except:
    #         return 0
    # #
    ...
    #     try:
    #         return self.get_total_net_weight()-self.get_kg_discounted()
    #     except:
    #         return 0
    # #
    # def get_discount_money_soles(self):
    #     try:
    #         return round(self.price_camp * self.get_kg_discounted(), 2)
    #     except:
    #         return 0
    #
    # def get_price_camp(self):
    #     try:
    #         kg_discount = Decimal(self.get_total_net_weight()) * (Decimal(self.lot.discount_price) / 100)
    ...
    #     try:
    #         return Decimal(self.get_kg_usable()) * Decimal(self.get_price_plant())
    #     except:
    #         return 0
    #
    # def get_total_amount_camp(self):
    #     try:
    #         return Decimal(self.get_kg_usable()) * Decimal(self.get_price_camp())
    #     except:
    #         return 0
    #
    # def get_freight_unit(self):
    #     try:
    #         return self.freight / self.get_total_net_weight()
    #     except:
    #         return 0
