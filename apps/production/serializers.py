...
class ProcessPineappleSerializer(serializers.ModelSerializer):
    ...
    performance_1_4 = serializers.CharField(source='get_performance_1_4', read_only=True)
    ...
    brute_kg_1_4 = serializers.CharField(source='get_brute_kg_1_4', read_only=True)
