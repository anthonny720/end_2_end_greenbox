...
export const delete_user = (id) => async dispatch => {
    ...
    try {
        const res = await axios.delete(`${process.env.REACT_APP_API_URL}/api/users/${id}/delete`, config);
        if (res.status === 200) {
            dispatch({
...
export const update_user = (form, id) => async dispatch => {
    ...
    try {
        const res = await axios.patch(`${process.env.REACT_APP_API_URL}/api/users/${id}/update`, form, config);
        if (res.status === 200) {
            dispatch({
