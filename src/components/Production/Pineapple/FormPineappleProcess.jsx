...
const FormProcessPineapple = ({close, data, category, params, typeform}) => {
    ...
    const columns_2 = [
        ...
        {name: 'quality', title: 'Calidad', type: 'text', maxLength: 5},
         {name: 'lot_cut_1_4', title: 'Lote 1/4', type: 'text', maxLength: 8},
...
const newSchema = () => {
    return {
        ...
        pt_cut_1_4: Yup.number().min(0).required(),
