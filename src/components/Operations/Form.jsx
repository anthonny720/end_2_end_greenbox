    ...
    return (
        <div className="w-full z-20">
            <form className="bg-white px-8 pt-6 pb-8 mb-4">
                ...
                {/*type*/}
                <div>
                    <p className={`${formik.errors.type && "text-red-500"} text-[10px]  font-extralight leading-none text-blue-400`}>Referencia
                        de precio:</p>
                ...
                {/*type_kg*/}
                <div>
                    <p className={`${formik.errors.type_kg && "text-red-500"} text-[10px]  font-extralight leading-none text-blue-400`}>Referencia
                ...
                {/*type_discount*/}
                <div>
                    <p className={`${formik.errors.type_discount && "text-red-500"} text-[10px]  font-extralight leading-none text-blue-400`}>Referencia
                        de descuento:</p>
