...
const TableCollection = ({data}) => {
    ...
    const RandomColoredText = ({text}) => {
        return <p className={'bg-opacity-20 p-2 rounded-md'}>{text}</p>;
    };
                ...
                <table className="min-w-full bg-white dark:bg-gray-800">
                    ...
                    {map(data, (value, index) => {
                        return (<tr className="h-max border-gray-300 dark:border-gray-200 border-b  " key={index}>
                            ...
                            <td className="text-sm pr-6 whitespace-wrap text-gray-800 font-bold dark:text-gray-100  leading-4 text-center ">
