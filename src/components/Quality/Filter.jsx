...
const Filter = ({products, setParams, action, latestObject, reference}) => {
    ...
    return (<form className="w-full  rounded-lg bg-white text-black">
        ...
        <div className="flex items-center justify-end mt-4">
            ...
            <div className={"flex items-center gap-2 "}>
                <DownloadTableExcel
                    filename={`Status de liberación : ${new Date(latestObject?.updated_at).toLocaleDateString('es-PE', {
        ...
        <div>
            <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 xl:grid-cols-4 gap-4 mt-4">
                ...
                <select value={formik.values.status}
                    ...
                    <option value={'O'}>Observado en MP</option>
                    <option value={'P'}>Espera de resultados</option>
                    <option value={'R'}>Liberado en P.T.</option>
                    <option value={'E'}>Producto no conforme</option>
